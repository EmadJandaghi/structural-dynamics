function M=GetTR2DMass(rho,refCoords,DOFConn,L0List,areaList,activeDOFs)
%% Info
% This function constructs consistent global mass matrix for a 2D Truss.
...
for e=1:nel
    ...
    L0=L0List(e);
    A=areaList(e);
    Me=(1/6)*(rho*A*L0)*[2,0,1,0;0,2,0,1;1,0,2,0;0,1,0,2];
